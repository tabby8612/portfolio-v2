  ...
  return (
    <section
      ...
      <div className="flex gap-30">
            ...
            <div className="flex w-full justify-between gap-5 my-5">
              <div id="nameinput">
                ...
                <input
                  ...
                  className="outline-0 border-1 border-gray-600 shadow py-2 px-3 rounded-lg w-sm text-lg bg-white"
                />
              </div>
              <div id="emailinput">
                <label
            ...
            <div className="flex w-full justify-between gap-5 my-5 ">
              <div id="subjectinput">
                ...
                <input
                  ...
                  id="subject"
                  placeholder="Subject"
                  className="outline-0 border-1 border-gray-600 shadow py-2 px-3 rounded-lg text-lg w-[49.3rem] object-contain bg-white"
                />
              </div>
            </div>
            <div className="flex w-full justify-between gap-5 my-5 ">
        ...
        <div
          id="contact-info"
          className="w-1/4 my-auto mx-auto">
          ...
          <div className="flex gap-3 items-center">
            <BaselineEmail className="text-6xl p-4 dark:bg-gray-600  bg-white rounded-lg text-primary-color my-3" />
            <div>
              <p className="text-gray-400 text-sm font-primary-font">Email</p>
              <p className="text-md font-primary-font font-medium">admin@tabishsajwani.com</p>
            </div>
          </div>
          <div className="flex gap-3 items-center">
